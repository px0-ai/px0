...
- **[Getting Started with Search Integration](get-started-search.md):** Learn how to search your prompt, skill, and tool registries across project boundaries using natural-language queries.
