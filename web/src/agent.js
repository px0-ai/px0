...
async function showPicker(session) {
  ...
  if (!ready.length) {
    ...
    session.pickEl.innerHTML = '<div class="hint" style="line-height: 1.5; padding: 4px 2px;">' +
      'Could not find any coding harness like <b>Claude Code</b>, <b>OpenCode</b>, <b>Codex</b>, <b>Antigravity</b> (<code>agy</code>), <b>Aider</b>, <b>Goose</b>, <b>Gemini CLI</b>, <b>Cursor Agent</b>, or <b>GitHub Copilot CLI</b> (<code>copilot</code>).<br><br>' +
