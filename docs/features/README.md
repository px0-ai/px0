...
| **Git Awareness & Diffs** | `Cmd/Ctrl+D` | Real-time status stream, stat cache fast-path, split / unified diffs, and auto-closing diff tabs | [Git Integration](git-integration.md) |
