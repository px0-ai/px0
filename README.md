...
- Tab management: Right-click a file tab to close it, close all tabs, close other tabs, or close tabs to its left or right. When many tabs are open, the tab strip scrolls while view controls stay accessible; narrow editors group view controls under View options.
