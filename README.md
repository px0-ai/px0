...
- **File Breadcrumbs**: Always-visible active-file paths with native horizontal scrolling; workspace directories reveal their Explorer entry, while external LSP paths stay informational.
