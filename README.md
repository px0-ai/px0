...
- **Sticky Symbol Context**: While scrolling a file, the current enclosing function, method, class, or type stays visible at the top of the code view, similar to VS Code.
